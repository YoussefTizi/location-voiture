...
// Validate ../../src/app/api/admin/state/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/state">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/state/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
